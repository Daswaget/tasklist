        ...
        if ($_SESSION["login"] == "")
            {
                echo
                    "<div class='block3'>
                        <h5 style='margin-top: 12px;'><a href='account/register.php'>Регистрация</a></h5>
                        <h5><a href='account/login.php'>Вход</a></h5>
                    </div>";
            } else
            {
                echo "<div class='block4'><div class='text3'>Здравствуйте, " . htmlspecialchars("$login") . "!</div>";
                echo "<div class='text4'><a href='account/logout.php'>Выйти</a></div></div>";
                echo "<div class='block2'>" .
                    '<form action="tasks/task_check.php" method="post">
